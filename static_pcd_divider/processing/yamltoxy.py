...
yaml_file_path = '/home/sayon/autoware_map/town01/splitted_' + str(matrix_size) + '/' + str(matrix_size) + '_metadata.yaml'

tiles_file_path = "/home/sayon/autoware_map/town01/splitted_" + str(matrix_size) + "/"
